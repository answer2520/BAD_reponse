...
<html>
<head>
  <title>Ajouter un secretaire</title>
</head>
<body>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlsecretaire = "INSERT INTO secretaire (matricule_sec, nom, Prenom, telephone, email, login, motDePass, profil)
   VALUES ('$matricule', '$nom', '$prenom', '$telephone', '$email', '$login', '$motDePasse', '$profil')";


if ($conn->query($sqlutilisateur) && $conn->query($sqlsecretaire)) {
