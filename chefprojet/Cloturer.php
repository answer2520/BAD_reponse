...
include "menu.php";
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $clo = $_POST["etatRealisation"];

    $sql = "UPDATE phase SET etatRealisation='$clo' WHERE codepha='$id'";
...
<body>
  <h1>Cloturer la phase  <?php echo $nomPhase; ?></h1>

  <form method="POST">

    <label for="montant"> 	État de réalisation :</label>
