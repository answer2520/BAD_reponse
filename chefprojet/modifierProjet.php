...
<body>
  ...
  <form method="POST" action="<?php echo $_SERVER["PHP_SELF"] . '?id=' . $id; ?>">
    ...
    <input type="text" id="code" name="code" value="<?php echo isset($code) ? $code : ''; ?>"  ><br>

    <label for="nom">Nom :</label>
    <input type="text" id="nom" name="nom" value="<?php echo isset($nom) ? $nom : ''; ?>"  ><br>

    <label for="description">Description :</label>
    <textarea id="description" name="description"  ><?php echo isset($description) ? $description : ''; ?></textarea><br>

    <label for="dateDebut">Date de début :</label>
    <input type="date" id="dateDebut" name="dateDebut" value="<?php echo isset($dateDebut) ? $dateDebut : ''; ?>"  ><br>

    <label for="dateFin">Date de fin :</label>
    <input type="date" id="dateFin" name="dateFin" value="<?php echo isset($dateFin) ? $dateFin : ''; ?>"  ><br>

    <!-- <label for="montant">Montant :</label>
    <input type="number" id="montant" name="montant" step="0.01" value="<?php echo isset($montant) ? $montant : ''; ?>"  ><br> -->
